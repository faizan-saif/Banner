(function() {
    ...
    e = /^\(?([^)]*)\)?(?:(.)(D*)(d*))?$/, t = 2e3, n = 2, i = 1e3 / 30, c = document.createElement("div").style, s = null != c.transition || null != c.webkitTransition || null != c.mozTransition || null != c.oTransition, h = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, o = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, u = function(t) {
        ...
        if (!v && null != window.jQuery) {
            for (v = !0, o = [], e = 0, n = (i = ["html", "text"]).length; e < n; e++) t = i[e], o.push(function(t) {
                var e;
        ...
        return r.prototype.renderInside = function() {
            ...
            var t, n, i, o, r, s, a, u, l, d;
            if ((t = null != (l = this.options.format) ? l : "(,ddd).dd") || (t = "d"), !(r = e.exec(t))) throw new Error("Odometer: Unparsable digit format");
            return u = (d = r.slice(1, 5))[0], a = d[1], i = d[2], o = d[3], s = (n = (null != i ? i.length : void 0) || 0) + (null != o ? o.length : void 0) || 0, this.format = {
                repeating: u,
                radix: a,
                precision: s,
                fractional: n
            ...
            var e, n, i, o, r, s, a, u, l, d, h;
            if (this.digits = [], this.options.formatFunction)
                for (a = 0, l = (d = this.options.formatFunction(t).split("").reverse()).length; a < l; a++)(s = d[a]).match(/[0-9]/) ? ((e = this.renderDigit()).querySelector(".odometer-value").innerHTML = s, this.digits.push(e), this.insertDigit(e)) : this.addSpacer(s);
            else {
                for (r = Math.abs(t), (n = Math.max(this.format.fractional, this.getFractionalDigitCount(r))) && (r = Math.round(r * Math.pow(10, n))), i = 0; r > 0;) this.addDigit((r % 10).toString(), i >= n), r = Math.floor(r / 10), (i += 1) === n && this.addDigit(".", !0);
                for (o = null != (h = this.options.minIntegerLen) ? h : 0, i = u = i - n; u < o; i = u += 1) this.addDigit(0, !0);
                t < 0 && this.addDigit("-", !0)
            }
        }, r.prototype.update = function(t) {
            var e, n = this;
            if (e = (t = this.cleanValue(t)) - this.value) return d(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), a(this.el, e > 0 ? "odometer-animating-up" : "odometer-animating-down"), this.stopWatchingMutations(), this.animate(t), this.startWatchingMutations(), setTimeout(function() {
            ...
            if (n = +t - this.value) return o = i = l(), e = this.value, (r = function() {
                var a, u;
                return l() - o > s.options.duration ? (s.value = t, s.render(), void m(s.el, "odometerdone")) : ((a = l() - i) > 50 && (i = l(), u = a / s.options.duration, e += n * u, s.render(Math.round(e))), null != h ? h(r) : setTimeout(r, 50))
            })()
        }, r.prototype.getDigitCount = function() {
            var t, e, n, i, o, r;
            for (t = o = 0, r = (i = 1 <= arguments.length ? b.call(arguments, 0) : []).length; o < r; t = ++o) n = i[t], i[t] = Math.abs(n);
            return e = Math.max.apply(Math, i), Math.ceil(Math.log(e + 1) / Math.log(10))
        }, r.prototype.getFractionalDigitCount = function() {
            var t, e, n, i, o, r, s;
            for (e = /^\-?\d*\.(\d*?)0*$/, t = r = 0, s = (o = 1 <= arguments.length ? b.call(arguments, 0) : []).length; r < s; t = ++r) i = o[t], o[t] = i.toString(), n = e.exec(o[t]), o[t] = null == n ? 0 : n[1].length;
            return Math.max.apply(Math, o)
        }, r.prototype.resetDigits = function() {
            return this.digits = [], this.ribbons = [], this.inside.innerHTML = "", this.resetFormat()
        }, r.prototype.animateSlide = function(t) {
            var e, n, i, o, r, s, u, l, d, h, p, c, m, g, v, M, w, y, b, T, x, E, D, L, S, F, C, A, H;
            if (w = this.value, (l = Math.max(this.format.fractional, this.getFractionalDigitCount(w, t))) && (t = Math.round(t * Math.pow(10, l)), w = Math.round(w * Math.pow(10, l))), i = t - w) {
                for (this.bindTransitionEnd(), v = null != (C = this.options.minIntegerLen) ? C : 0, o = Math.max(this.getDigitCount(w, t), v + l), r = [], e = 0, p = T = 0; 0 <= o ? T < o : T > o; p = 0 <= o ? ++T : --T) {
                    if (y = f(w / Math.pow(10, o - p - 1)), s = (u = f(t / Math.pow(10, o - p - 1))) - y, Math.abs(s) > this.MAX_VALUES) {
                        for (h = [], c = s / (this.MAX_VALUES + this.MAX_VALUES * e * .5), n = y; s > 0 && n < u || s < 0 && n > u;) h.push(Math.round(n)), n += c;
                        h[h.length - 1] !== u && h.push(u), e++
                    } else h = function() {
                        H = [];
                        for (var t = y; y <= u ? t <= u : t >= u; y <= u ? t++ : t--) H.push(t);
                        return H
                    }.apply(this);
                    for (p = x = 0, D = h.length; x < D; p = ++x) d = h[p], h[p] = Math.abs(d % 10);
                    r.push(h)
                }
                for (this.resetDigits(), p = E = 0, L = (A = r.reverse()).length; E < L; p = ++E)
                    for (h = A[p], this.digits[p] || this.addDigit(" ", p >= l), null == (b = this.ribbons)[p] && (b[p] = this.digits[p].querySelector(".odometer-ribbon-inner")), this.ribbons[p].innerHTML = "", i < 0 && (h = h.reverse()), m = F = 0, S = h.length; F < S; m = ++F) d = h[m], (M = document.createElement("div")).className = "odometer-value", M.innerHTML = d, this.ribbons[p].appendChild(M), m === h.length - 1 && a(M, "odometer-last-value"), 0 === m && a(M, "odometer-first-value");
                return y < 0 && this.addDigit("-"), null != (g = this.inside.querySelector(".odometer-radix-mark")) && g.parent.removeChild(g), l ? this.addSpacer(this.format.radix, this.digits[l - 1], "odometer-radix-mark") : void 0
            }
        }, r
    ...
    }, null != (null != (y = document.documentElement) ? y.doScroll : void 0) && null != document.createEventObject ? (M = document.onreadystatechange, document.onreadystatechange = function() {
